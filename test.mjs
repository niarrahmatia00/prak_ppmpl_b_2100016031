...
import { tambah, kali, kurang, bagi } from './math.js'; // Pastikan untuk menambahkan .js pada akhir nama file
...
describe('Pengujian Fungsi Matematika', function() {
    ...
    it('seharusnya mengembalikan 0 saat mengurangkan 2 dari 2', function() { 
